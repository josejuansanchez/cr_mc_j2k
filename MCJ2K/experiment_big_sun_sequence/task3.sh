...
##################################################################################
#
# NOTA: Este script calcula todos los vectores de movimiento y posteriormente se
#       procesan con el script "doaverage.sh"
#
##################################################################################
...
# Borramos el archivo de salida de gnuplot
rm gnuplot/prev.dat
...
do
  ...
  # Renombramos los archivos de salida
  mv vectors/prev.dat vectors/avg${num}.dat
