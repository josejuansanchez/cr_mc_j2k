...
def usage():
    sys.stderr.write("+-------------------+\n")
    sys.stderr.write("| MCTF analyze_step |\n")
    sys.stderr.write("+-------------------+\n")
    sys.stderr.write("\n")
    sys.stderr.write("  Description:\n")
    sys.stderr.write("\n")
    sys.stderr.write("   Performs a step the temporal analysis.\n")
    sys.stderr.write("\n")
...
os.system("mctf motion_estimate"
