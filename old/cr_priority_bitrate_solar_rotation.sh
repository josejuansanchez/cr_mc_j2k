...
# ROTAMOS EL BACKGROUND DE LA IMAGEN ANTERIOR
tools/sortcache $IMAGES/background.j2c.cache
CheckExitStatusCode
mv $IMAGES/background.j2c.cache.ord $IMAGES/background.j2c.cache
Code/CR/decodefromcache $IMAGES/background.j2c.cache $IMAGES/background.j2c.cache.pgm $WIDTH_RECONS $HEIGHT_RECONS ../data/thumbnails/000.j2c
CheckExitStatusCode

# TODO: Ajustar como parametro de entrada "timedifference"
solar_rotation/Debug/SolarRotation $IMAGES/background.j2c.cache.pgm $IMAGES/background.next.pgm
###########


# CREAMOS EL NUEVO BACKGROUND
...
# PRUEBA: Hacemos la media de las dos imágenes
tools/fusion2 $IMAGES/background.next.pgm $IMAGES/${i_next_index}.j2c.cache.ord.pgm $IMAGES/temp.next.pgm
mv $IMAGES/temp.next.pgm $IMAGES/background.next.pgm

# Copiamos las WOIs de la siguiente imagen sobre el background
tools/fusion $IMAGES/background.next.pgm $IMAGES/${i_next_index}.j2c.cache.ord.pgm ../data/thumbnails/${i_next_index}.j2c.woi $W_PRECINT_SIZE $H_PRECINT_SIZE ../data/imagesprecincts/${i_next_index}.pgm
###
