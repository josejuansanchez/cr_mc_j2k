...
public class Kdu_global {
  ...
  public static final String KDU_CORE_VERSION = (String) "v6.4.1";
  ...
  public static final int KDU_CLIENT_WINDOW_IS_MOST_RECENT = (int) 1;
  public static final int KDU_CLIENT_WINDOW_RESPONSE_TERMINATED = (int) 2;
  public static final int KDU_CLIENT_WINDOW_IS_COMPLETE = (int) 4;
