...
public class Kdu_region_compositor {
  ...
  public native boolean Process(int _suggested_increment, Kdu_dims _new_region, int _flags) throws KduException;
  public boolean Process(int _suggested_increment, Kdu_dims _new_region) throws KduException
  {
    return Process(_suggested_increment,_new_region,(int) 0);
  }
  ...
  public native void Invalidate_rect(Kdu_dims _region) throws KduException;
  ...
  public native boolean Get_codestream_packets(Kdu_istream_ref _istream_ref, Kdu_dims _region, long[] _visible_precinct_samples, long[] _visible_packet_samples, long[] _max_visible_packet_samples) throws KduException;
