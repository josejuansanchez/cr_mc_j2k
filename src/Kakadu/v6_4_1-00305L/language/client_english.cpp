...
static kdl_message_info data[61] = {
  {
    "E(kdu_client.cpp)", 1,
  ...
  },
  {
    "E(kdu_client.cpp)", 13,
    "Error in Kakadu Client:\n",
    "Unable to complete auxiliary return connection to server.\0"
  },
  {
    "E(kdu_client.cpp)", 14,
    "Error in Kakadu Client:\n",
  ...
  },
  {
    ...
    "Error in Kakadu Client:\n",
    "Server's response data seems to be getting ahead of receiver's requests!!!  All outstanding response data for issued requests on an HTTP-TCP JPIP channel have been received over the auxiliary channel, yet there is still more data available!\0"
  },
  {
  ...
  },
  {
    "E(kdu_clientx.cpp)", 2,
    "Error in Kakadu Client:\n",
    "Invalid codestream registration box found in compositing layer header box: attempting to use a non existent codestream.\0"
  },
  {
    "E(kdu_clientx.cpp)", 3,
    "Error in Kakadu Client:\n",
...
static bool dummy_val = kdl_register_text(data,61);
