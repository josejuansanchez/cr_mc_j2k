...
static kdl_message_info data[78] = {
  ...
  },
  {
    "E(jp2.cpp)", 13,
    "Error in Kakadu File Format Support:\n",
    "Unable to open the box identified by the `jp2_locator' object supplied to `jp2_input_box::open'.  The server is deliberately preventing access to the the box or any stream equivalent.\0"
  },
  {
    "E(jp2.cpp)", 22,
    "Error in Kakadu File Format Support:\n",
...
static kdl_message_info dev_data[69] = {
  ...
  },
  {
    "E(jp2.cpp)", 23,
    "Error in Kakadu File Format Support:\n",
    "Non-seekable JP2 sources must be read sequentially.  You are attempting to read from multiple boxes simultaneously.\0"
  },
  {
    "E(jp2.cpp)", 24,
    "Error in Kakadu File Format Support:\n",
