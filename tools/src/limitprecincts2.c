...
int main (int argc, char *argv[])
{
    ...
    if (argc!=7)
    {
	printf("\nUso: %s <filename_precincts_list_in DAT> <filename_precincts_list_out> <precinct_size> <threshold> <filename_precincts_descartados_txt> <filename_precincts_filtrados_txt>.",argv[0]);
